...
![Sistema Operativo Detectado](imagenes/foto2.png)

* **Estado del Host:** Activo (Up) con una latencia de 0.22s.

![Latencia y Estado](imagenes/foto3.png)
...
![Panel de Puertos y Servicios 1](imagenes/foto4.png)
![Panel de Puertos y Servicios 2](imagenes/foto5.png)

* **Puertos Abiertos:** El sistema reporta **5 puertos abiertos** activos.
...
![Detalles del Host](imagenes/foto6.png)
...
![Topología de Red](imagenes/foto7.png)
